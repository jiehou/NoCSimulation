...
public:
  ...
  bool getShouldDiscardLocal() const;
...
private:
  ...
  // if the neighbor router at the selected direction is faulty
  // the packet should be discarded by the local PE 
  bool should_discard_local; 
};
